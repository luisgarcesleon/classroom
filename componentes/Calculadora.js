class Calculadora extends React.Component {
    ...
    render() {
        return (
            <div>
                <div className="z-depth-2 teal white-text center-align resultados">
                    {this.state.res || "0"}
                </div>
                <div className="calc-container blue lighten-3 hoverable z-depth-2">
                    ...
                    <a className="waves-effect waves-light btn-large deep-orange darken-1" onClick={this.ejecutarOperacion}>=</a>
